...
import { BrokenCloudPricedValue, CloudPricedValue } from '../model/price-scale';
import { SeriesItemsIndexesRange, TimedRange, TimedValue } from '../model/time-data';

import { ScaledRenderer } from './scaled-renderer';

export type CloudLineItem = TimedValue & CloudPricedValue;
export type BrokenCloudLineItem = TimedRange & BrokenCloudPricedValue;
...
export class PaneRendererCloudArea extends ScaledRenderer {
	...
	protected _drawImpl(ctx: CanvasRenderingContext2D): void {
		...
		let firstPoint = this._data.visibleRange.from;
